...
switch (EnvKey) {
	...
	case 3:
		...
		GLOBALDATA.APPCODE = 'wechatapp#'; //应用系统代码
		...
		GLOBALDATA.INTERFACE_ITEM ='http://develop309.jiaobaowang.net/imsubapi/sub/api/'; //物品管理接口(孔)  http://115.28.11.115:8080/imsubapi/sub/api/
