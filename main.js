...
switch (EnvKey) {
	...
	case 3:
		...
		GLOBALDATA.INTERFACE_OA = 'https://developgx.108800.com:8443/oasubapi/sub/api/'; //oa接口(孔)
		GLOBALDATA.INTERFACE_ITEM = 'https://developgx.108800.com:8443/imsubapi/sub/api/'; //物品管理接口(孔)  http://115.28.11.115:8080/imsubapi/sub/api/
		...
		GLOBALDATA.INTERFACE_DORM1 = 'https://developgx.108800.com:8443/stusssubapi/api/'; //学生宿舍（阮)
		...
		GLOBALDATA.STULEAVE_API = 'https://developgx.108800.com:8443/stuleavesubapi/sub/api/'; //学生请假系统(孔)
		GLOBALDATA.INTERFACE_TWJK_TEA = 'https://developgx.108800.com:8443/stustatsubapi/api/'; //学生每日体温监控（农）
		GLOBALDATA.INTERFACE_COSTMS = 'https://developgx.108800.com:8443/cmsubapi/sub/api/'; //费用管理（孔）
		GLOBALDATA.INTERFACE_HEALTH_DATA = 'https://developgx.108800.com:8443/stuhealth/api/'; //健康数据（蒙）
		GLOBALDATA.INTERFACE_LHKP = 'https://developgx.108800.com:8443/stuxwsubapi/evaluation/'; //量化考评（孔) 
	...
	case 4:
		...
		GLOBALDATA.INTERFACE_BASESUB = 'https://test.108800.com/baseapi/api/baseapi/'; //统一信息接口:考务、家校用(顾)
		GLOBALDATA.INTERFACE_UCARD = 'https://test.108800.com/ucardsubapi/api/ucard/'; //统一信息接口 中小学学校卡(顾)
	...
	case 5:
		...
		GLOBALDATA.INTERFACE_UCARD = 'https://apps.108800.com:8443/ucardsubapi/api/ucard/'; //统一信息接口 中小学学校卡(顾)
