...
function getPageArray() {
	...
	let tempArray = [{
		...
		},
		{
			...
			isDot: false,
			customIcon: false,
			img_href: tempAAA + "/static/tabbar/zuoyeyuzhouce_img.png",
			url: 'schapp_homework',
			childList: [{
				name: '批改',
		...
		},
		{
			...
			childList: [{
				name: '成长档案',
				icon: tempAAA + '/static/images/mixedAbl/chengzhangdangan.png',
		...
		},
		{
			...
			childList: [{
				name: '学生评价',
				icon: tempAAA + '/static/images/mixedAbl/xueshengpingjia.png',
