<template>
	<view>
		<mynavBar ref="mynavBar" :navItem='navItem' :personInfo='personInfo' text="点名添加" :textClick="textClick"></mynavBar>
		...
		methods: {
			textClick(){
				if(_this.grdArray.length==0){
					...
					util.openwithData('/pages/schapp_work/ketangAdd',{index_code:_this.index_code})
