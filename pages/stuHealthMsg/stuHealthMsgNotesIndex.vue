<template>
	<view>
		...
		<uni-list :border="false">
			...
			<uni-list-item showArrow direction='column' clickable
				@click="clickItem(model)" :border="true">
				<view slot="body" class="slot-box slot-text">
					<view class="rightView">
						<uni-row class="nameTime">
							<uni-col :span="12">
								<view style="font-size: 12px;">2022-08-21健康上报</view>
							</uni-col>
							<uni-col :span="12">
								<view style="font-size: 12px;text-align: right;">2022-08-21 12：00</view>
							</uni-col>
						</uni-row>
					</view>
				</view>
