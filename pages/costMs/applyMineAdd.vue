<template>
	<view>
		...
		<input type="number" v-model="title" class="rightView" style="margin-top: 10px;"
			placeholder="请输入金额" />
					...
					<uni-row>
						...
						<uni-col :span="12" style="">
							<picker @change="selectFlowChange" value="0" :range="selectFlowArray" range-key="flow_name"
								style="height: 0px;">
								<view class="uni-input" style="padding: 0px;font-size: 16px;border-left: 1px solid #AAAAAA;padding-left: 15px;">点击添加审批流程</view>
							</picker>
						</uni-col>
					</uni-row>
				</view>
