<template>
  <view>
    ...
    <view class="uni-flex uni-pa-4 button-group">
      <button
        class="uni-flex-item"
        :class="codeColor === 'r' ? 'active' : ''"
        @click="onColorChange('r')"
      >
        红码
      </button>
      <button
        class="uni-flex-item"
        :class="codeColor === 'y' ? 'active' : ''"
        @click="onColorChange('y')"
      >
        黄码
      </button>
    </view>
      ...
      <uni-list :border="false">
        ...
        >
          <view style="width: 100%" slot="body">
            <uni-row>
              <uni-col class="uni-center" :span="7">{{
                item.grd_name
              }}</uni-col>
              <uni-col class="uni-center" :span="7">{{
                item.cls_name
              }}</uni-col>
              <uni-col class="uni-center" :span="10">{{
                item.stu_name
              }}</uni-col>
            </uni-row>
          </view>
